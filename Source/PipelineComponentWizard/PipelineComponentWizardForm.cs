...
namespace MartijnHoogendoorn.BizTalk.Wizards.PipeLineComponentWizard
{
	public class PipeLineComponentWizardForm : Microsoft.BizTalk.Wizard.WizardForm
	{
		...
		private WzPageDesignerProperties WzPageDesignerProperties1;
		private WzPageGeneralSetup wzPageGeneralSetup1;
		private WzPageGeneralProperties WzPageGeneralProperties1;
		...
		/// </summary>
		public PipeLineComponentWizardForm(_DTE ideObject, object[] contextParams)
		{

	     //   private _DTE _IDEObject;
	     //   private object[] _ContextParams;

      //      // Private class variable to fecth current solution name if any loaded when the wizard runs
		    //_IDEObject = ideObject;
            ...
            var _FExclusive = bool.Parse(contextParams[(int)BizTalkPipeLineWizard.ContextOptions.FExclusive].ToString());	
